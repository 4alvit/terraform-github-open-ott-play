...
# =============================================================================
# Retired: foss-cloudflare-infrastructure relocated to
# victron-venus/terraform-cloudflare-inverter-gateway. Drop from state without
# destroying the (soon-to-be-archived) GitHub repo.
# =============================================================================
removed {
